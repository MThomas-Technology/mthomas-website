<template>
  <div>
    <form @submit.prevent="submit" name="homepage">
      <input type="hidden" name="form-name" value="homepage" />
      <div class="inline">
        <div
          class="input-wrap"
          :class="{ 'input-wrap--error': $v.form.name.$error }"
        >
          <input
            id="name"
            name="name"
        ...
        <div
          class="input-wrap"
          :class="{ 'input-wrap--error': $v.form.organisation.$error }"
        >
          <input
            id="organisation"
            name="organisation"
          ...
          <span class="error" v-if="$v.form.organisation.$error"
            >Please enter your organisation</span
          >
        </div>
      </div>
      <div
        class="input-wrap"
        :class="{ 'input-wrap--error': $v.form.email.$error }"
      >
        <input
          id="email"
          name="email"
      ...
      <div
        class="input-wrap"
        :class="{ 'input-wrap--error': $v.form.description.$error }"
      >
        <textarea
          id="description"
          name="description"
        ...
        <span class="error" v-if="$v.form.description.$error"
          >Let me know how I can help!</span
        >
      </div>
    ...
    <TransitionSlideToggle>
      <div class="feedback" v-show="submitted">
        Thanks! Your message has been sent.<br />I'll get back to you as soon as
        possible.
      </div>
    </TransitionSlideToggle>
  </div>
